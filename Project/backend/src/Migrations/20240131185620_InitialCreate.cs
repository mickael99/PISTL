    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__SingleSi__97C702DE854896F8", x => x.ContactPersonID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserName = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    UserActive = table.Column<bool>(type: "bit", nullable: false),
                    LoginEnabled = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    LoginTypeId = table.Column<int>(type: "int", nullable: true),
                    AnalyticsEnabled = table.Column<bool>(type: "bit", nullable: true),
                    IsLight = table.Column<bool>(type: "bit", nullable: true),
                    SysAdmin = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LoginDomainUser", x => new { x.LoginID, x.DomainID, x.UserID, x.Environment });
                    table.ForeignKey(
                        name: "FK_LoginDomainUser_Domain",
                        column: x => x.DomainID,
                        principalTable: "Domain",
                        principalColumn: "DomainID");
                    table.ForeignKey(
                        name: "FK_LoginDomainUser_Login",
                        column: x => x.LoginID,
                        principalTable: "Login",
                        principalColumn: "LoginID");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModifiedDate = table.Column<DateOnly>(type: "date", nullable: false, defaultValueSql: "(getdate())"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__SingleSi__CB1BECB8D19D0446", x => x.SingleSignOnID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LoginDomainUser_DomainID",
