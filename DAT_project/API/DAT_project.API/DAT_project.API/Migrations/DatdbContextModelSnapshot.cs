...
{
    [DbContext(typeof(DatdbContext))]
    partial class DatdbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAT_project.API.Models.Database", b =>
                {
            ...
            modelBuilder.Entity("DAT_project.API.Models.Domain", b =>
                {
            ...
            modelBuilder.Entity("DAT_project.API.Models.DomainEnvironment", b =>
                {
            ...
            modelBuilder.Entity("DAT_project.API.Models.DomainLog", b =>
                {
            ...
            modelBuilder.Entity("DAT_project.API.Models.IpBlacklist", b =>
                {
            ...
            modelBuilder.Entity("DAT_project.API.Models.Login", b =>
                {
            ...
            modelBuilder.Entity("DAT_project.API.Models.LoginAuthorizationException", b =>
                {
                    b.Property<int>("LoginId")
                        .HasColumnType("int")
                        .HasColumnName("LoginID");
            ...
            modelBuilder.Entity("DAT_project.API.Models.LoginDomainUserLog", b =>
                {
            ...
            modelBuilder.Entity("DAT_project.API.Models.LoginImage", b =>
                {
            ...
            modelBuilder.Entity("DAT_project.API.Models.LoginLog", b =>
                {
            ...
            modelBuilder.Entity("DAT_project.API.Models.LoginNews", b =>
                {
            ...
            modelBuilder.Entity("DAT_project.API.Models.LoginPasswordRule", b =>
                {
            ...
            modelBuilder.Entity("DAT_project.API.Models.PasswordHistory", b =>
                {
            ...
            modelBuilder.Entity("DAT_project.API.Models.Redirect", b =>
                {
            ...
            modelBuilder.Entity("DAT_project.API.Models.Server", b =>
                {
                    b.Property<int>("ServerId")
                        .HasColumnType("int")
                        .HasColumnName("ServerID");
            ...
            modelBuilder.Entity("DAT_project.API.Models.ServerParameter", b =>
                {
                    b.Property<int>("ServerId")
                        .HasColumnType("int")
                        .HasColumnName("ServerID");
            ...
            modelBuilder.Entity("DAT_project.API.Models.Session", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DAT_project.API.Models.SingleSignOnCredentialMapping", b =>
                {
            ...
            modelBuilder.Entity("DAT_project.API.Models.SingleSignOnMethod", b =>
                {
                    ...
                    b.HasKey("SingleSignOnId")
                        .HasName("PK__SingleSi__CB1BECB8EB71497D");
            ...
            modelBuilder.Entity("DAT_project.API.Models.SingleSignOnSaml2ContactPerson", b =>
                {
                    ...
                    b.HasKey("ContactPersonId")
                        .HasName("PK__SingleSi__97C702DE6E6F4D07");

                    b.ToTable("SingleSignOnSaml2ContactPerson", (string)null);
                });

            modelBuilder.Entity("DAT_project.API.Models.SingleSignOnSaml2IdentityProviderInfo", b =>
                {
                    b.Property<int>("Saml2IdentityProviderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DAT_project.API.Models.SingleSignOnSaml2IdentityProviderInfoDomain", b =>
                {
            ...
            modelBuilder.Entity("DAT_project.API.Models.UserSetting", b =>
                {
            ...
            modelBuilder.Entity("DAT_project.API.Models.Database", b =>
                {
                    b.HasOne("DAT_project.API.Models.Server", "Server")
                        .WithMany("Databases")
            ...
            modelBuilder.Entity("DAT_project.API.Models.LoginAuthorizationException", b =>
                {
                    b.HasOne("DAT_project.API.Models.Login", "Login")
                        .WithOne("LoginAuthorizationException")
                        .HasForeignKey("DAT_project.API.Models.LoginAuthorizationException", "LoginId")
                        .IsRequired()
            ...
            modelBuilder.Entity("DAT_project.API.Models.SingleSignOnCredentialMapping", b =>
                {
                    ...
                    b.HasOne("DAT_project.API.Models.SingleSignOnSaml2IdentityProviderInfo", "Saml2IdentityProvider")
                        .WithMany("SingleSignOnCredentialMappings")
