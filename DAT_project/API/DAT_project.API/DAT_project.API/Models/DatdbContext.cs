...
public partial class DatdbContext : DbContext
{
    public DatdbContext()
    {
    }

    public DatdbContext(DbContextOptions<DatdbContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.SingleSignOnId).HasName("PK__SingleSi__CB1BECB8EB71497D");
        ...
        {
            entity.HasKey(e => e.ContactPersonId).HasName("PK__SingleSi__97C702DE6E6F4D07");
